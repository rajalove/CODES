...
apiRouter.get('/students/:stuId',(request:express.Request,response:express.Response)=>
{
   ...
   let selectedPerson:IStudent|undefined=students.find((stu)=>
   {
       return stu.id==stuId;
   })
   ...
   {
response.status(200).json({Raja:selectedPerson,id:stuId})
}
});
...
apiRouter.post('/students',(request:express.Request,response:express.Response)=>
{
    ...
    let newPerson:IStudent={
      name: request.body.name,
      username: request.body.username,
      email: request.body.email,
      website: request.body.ipAddress,
